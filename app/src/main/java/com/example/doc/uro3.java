...
public class uro3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uro3);
        ...
        button7 = (Button) findViewById(R.id.location3);
        button8 = (Button) findViewById(R.id.appointment3);
